...
class ArrayOfJP_CruiseExtendedRelPax implements \ArrayAccess, \Iterator, \Countable
{

    /**
     * @var JP_CruiseExtendedRelPax[] $RelPax
     */
    ...
    /**
     * @param JP_CruiseExtendedRelPax[] $RelPax
     ...
     * @param JP_CruiseExtendedRelPax $value The value to set
     * @return void
     */
     ...
     *
     * @return JP_CruiseExtendedRelPax Return the current element
     */
     ...
     *
     * @return JP_CruiseExtendedRelPax Return count of elements
     */

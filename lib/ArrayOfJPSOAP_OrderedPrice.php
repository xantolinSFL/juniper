...
class ArrayOfJPSOAP_OrderedPrice implements \ArrayAccess, \Iterator, \Countable
{

    /**
     * @var JPSOAP_OrderedPrice[] $AdultAdditional
     */
    ...
    /**
     * @param JPSOAP_OrderedPrice[] $AdultAdditional

...
class ArrayOfJP_RelPax implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @param JP_RelPax $value The value to set
     * @return void
     */
     ...
     *
     * @return JP_RelPax Return the current element
     */
     ...
     *
     * @return JP_RelPax Return count of elements
     */

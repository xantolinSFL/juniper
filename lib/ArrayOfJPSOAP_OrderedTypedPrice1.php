...
class ArrayOfJPSOAP_OrderedTypedPrice1 implements \ArrayAccess, \Iterator, \Countable
{

    /**
     * @var JPSOAP_OrderedTypedPrice[] $ChildA
     */
    ...
    /**
     * @param JPSOAP_OrderedTypedPrice[] $ChildA

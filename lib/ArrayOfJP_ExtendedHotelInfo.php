...
class ArrayOfJP_ExtendedHotelInfo implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @param JP_ExtendedHotelInfo $value The value to set
     * @return void
     */
     ...
     *
     * @return JP_ExtendedHotelInfo Return the current element
     */
     ...
     *
     * @return JP_ExtendedHotelInfo Return count of elements
     */

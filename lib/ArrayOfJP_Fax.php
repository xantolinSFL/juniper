...
class ArrayOfJP_Fax implements \ArrayAccess, \Iterator, \Countable
{
     ...
     * @param JP_Fax $value The value to set
     * @return void
     */
     ...
     *
     * @return JP_Fax Return the current element
     */
     ...
     *
     * @return JP_Fax Return count of elements
     */

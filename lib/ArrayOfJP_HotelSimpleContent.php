...
class ArrayOfJP_HotelSimpleContent implements \ArrayAccess, \Iterator, \Countable
{
    ...
    /**
     * @var JP_HotelSimpleContent[] $Hotel
     */
    ...
    /**
     * @param JP_HotelSimpleContent[] $Hotel
     ...
     * @param JP_HotelSimpleContent $value The value to set
     * @return void
     */
     ...
     *
     * @return JP_HotelSimpleContent Return the current element
     */
     ...
     *
     * @return JP_HotelSimpleContent Return count of elements
     */

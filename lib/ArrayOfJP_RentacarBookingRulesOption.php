...
class ArrayOfJP_RentacarBookingRulesOption implements \ArrayAccess, \Iterator, \Countable
{

    /**
     * @var JP_RentacarBookingRulesOption[] $RentacarOption
     */
    ...
    /**
     * @param JP_RentacarBookingRulesOption[] $RentacarOption
     ...
     * @param JP_RentacarBookingRulesOption $value The value to set
     * @return void
     */
     ...
     *
     * @return JP_RentacarBookingRulesOption Return the current element
     */
     ...
     *
     * @return JP_RentacarBookingRulesOption Return count of elements
     */

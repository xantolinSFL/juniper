...
class ArrayOfJPSOAP_OrderedTypedPrice implements \ArrayAccess, \Iterator, \Countable
{

    /**
     * @var JPSOAP_OrderedTypedPrice[] $AdultAdditional
     */
    ...
    /**
     * @param JPSOAP_OrderedTypedPrice[] $AdultAdditional

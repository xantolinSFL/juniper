...
class ArrayOfJPSOAP_HotelRatePlanSupplement implements \ArrayAccess, \Iterator, \Countable
{

    /**
     * @var JPSOAP_HotelRatePlanSupplement[] $Supplement
     */
    ...
    /**
     * @param JPSOAP_HotelRatePlanSupplement[] $Supplement
     ...
     * @param JPSOAP_HotelRatePlanSupplement $value The value to set
     * @return void
     */
     ...
     *
     * @return JPSOAP_HotelRatePlanSupplement Return the current element
     */
     ...
     *
     * @return JPSOAP_HotelRatePlanSupplement Return count of elements
     */
